 ...
 *                RSAStreamEncodeDecodeTest.java
 */
package test.util;

import torrefactor.util.RsaInputStream;
import torrefactor.util.RsaOutputStream;
...
public class RSAStreamEncodeDecodeTest {
    ...
    public static void main (String[] args) {
        org.junit.runner.JUnitCore.main("test.util.RSAStreamEncodeDecodeTest");
    }
    
    @Test
    public void testEncryptingDecryptingStreamsSingleLine()
    throws IOException {
        for (int i = 4; i < 9; i++) {
            ...
            OutputStream out = new RsaOutputStream(buffer, rsa);
            ...
            InputStream in = new RsaInputStream(
