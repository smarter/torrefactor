...
#package targets
test : $(call PACKAGE_OBJS,test)
src : $(call PACKAGE_OBJS,src)
src.torrefactor : $(call PACKAGE_OBJS,src.torrefactor)
test.core : $(call PACKAGE_OBJS,test.core)
